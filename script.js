...
const levelsData = [
        ...
        questions: [
            {
                ...
                tutorial: {
                    title: "شرح قبل البدء: ملخص المفهوم 💡",
                    equation: "",
                    steps: [
                        { text: "لتحديد عدد الحلول لنظام من معادلتين، نُعاين قيم الميل والمقطع y لكلتيهما.", math: "" },
                        { text: "أولاً: إذا اختلف الميلان، يتقاطع المستقيمان في نقطة واحدة.", math: "حل واحد" },
                        { text: "ثانياً: إذا تشابها في الميل واختلفا في المقطع y، فالمستقيمان متوازيان.", math: "ليس لها حل" },
                        { text: "ثالثاً: إذا تشابها في الميل وفي المقطع y، فالمستقيمان متطابقان تماماً.", math: "عدد لانهائي من الحلول" }
                    ]
                },
                equation: "\\begin{cases} y = \\frac{1}{2}x + 1 \\\\ -2x + 4y = 4 \\end{cases}",
                steps: [
                    { skill: "تحديد عدد الحلول بيانياً", expected: "عدد لانهائي من الحلول", options: ["x = 0, y = 2", "ليس للنظام حل", "عدد لانهائي من الحلول"], userInstruction: "تدريب (1): إذا قمت بتبسيط المعادلة الثانية ستجد أنها مطابقة تماماً للأولى. ما هو عدد الحلول بناءً على ذلك؟", hint: "المعادلتان متطابقتان، فهما يمثلان نفس الخط المستقيم.", success: "ممتاز! ينطبقان على بعضهما لذا يوجد عدد لانهائي من الحلول." }
                ],
                backup: {
                    equation: "\\begin{cases} y = 3x - 2 \\\\ -6x + 2y = -4 \\end{cases}",
                    steps: [
                        { skill: "تحديد عدد الحلول بيانياً", expected: "عدد لانهائي من الحلول", options: ["حل واحد", "ليس للنظام حل", "عدد لانهائي من الحلول"], userInstruction: "سؤال تدريبي: كم عدد الحلول لهذا النظام الدقيق؟", hint: "المعادلتان متطابقتان تماماً.", success: "أحسنت!" }
                    ]
                }
            },
            {
                skill: "المستقيمات المتوازية (ليس للنظام حل)",
                equation: "\\begin{cases} y = -x - 3 \\\\ y + x = 2 \\end{cases}",
                steps: [
                    { skill: "تمييز أنظمة المعادلات المتوازية", expected: "ليس للنظام حل", options: ["x = 0, y = 2", "ليس للنظام حل", "عدد لانهائي من الحلول"], userInstruction: "تدريب (2): المعادلة الثانية يمكن كتابتها y = -x + 2. كلا المستقيمين لهما نفس الميل ومقاطع مختلفة. ماذا نستنتج للحل؟", hint: "المستقيمان متوازيان ولن يتقاطعا أبداً.", success: "إجابة دقيقة! ليس للنظام حل." }
                ]
            },
            {
                skill: "المستقيمات المتقاطعة (نقطة حل محددة)",
                equation: "\\begin{cases} 2y = 6x + 4 \\\\ y = -2x + 2 \\end{cases}",
                steps: [
                    { skill: "إيجاد نقطة التقاطع", expected: "x = 0, y = 2", options: ["x = 0, y = 2", "x = 2, y = 0", "ليس للنظام حل", "عدد لانهائي من الحلول"], userInstruction: "تدريب (3): المعادلتان تتقاطعان في نقطة المقطع Y (لأن كلاهما يملك b=2). ما هو الحل إذن؟", hint: "النقطة تقع على المحور Y، وهذا يعني x=0 و y=2.", success: "رائع! النقطة (0, 2) هي نقطة التقاطع الوحيدة." }
                ]
            }
        ]
    },
        ...
        questions: [
            {
                ...
                tutorial: {
                    ...
                    steps: [
                        ...
                        { text: "ثانياً: نجمع قيم (x) المتغير في طرف والأرقام في طرف ونحل.", math: "$$3x = -3 \\Rightarrow x = -1$$" },
    ...
    {
        level: 4,
        title: "المستوى الرابع: الاختبار النهائي الشامل",
        questions: [
            {
                ...
                equation: "\\begin{cases} y = x + 3 \\\\ y = 2x + 4 \\end{cases}",
                steps: [
                    { skill: "الاختبار النهائي 1", expected: "x = -1, y = 2", options: ["x = -1, y = 2", "x = 1, y = 4", "x = -1, y = -2", "ليس للنظام حل"], userInstruction: "أوجد الحل النهائي للنظام التالي بطريقة التعويض:", hint: "هذا اختبار! الجواب الصحيح يحتاج تركيز.", success: "إجابة صحيحة! أحسنت صنعاً." }
                ]
            },
            {
                skill: "تطبيق شامل - السؤال الثاني",
                equation: "\\begin{cases} 3x + y = 14 \\\\ -3x + y = 2 \\end{cases}",
                steps: [
                    { skill: "الاختبار النهائي 2", expected: "x = 2, y = 8", options: ["x = 2, y = 8", "x = 4, y = 2", "x = 8, y = 2", "عدد لانهائي من الحلول"], userInstruction: "أوجد الحل النهائي للنظام التالي بطريقة الحذف:", hint: "هذا اختبار! الجواب الصحيح يحتاج تركيز.", success: "بطل! استنتاج سليم." }
                ]
            },
            {
                skill: "تطبيق شامل - السؤال الثالث",
                equation: "\\begin{cases} y = 5x - 1 \\\\ -5x + y = 3 \\end{cases}",
                steps: [
                    { skill: "الاختبار النهائي 3", expected: "ليس للنظام حل", options: ["x = 0, y = -1", "ليس للنظام حل", "عدد لانهائي من الحلول", "x = 1, y = 4"], userInstruction: "كم عدد الحلول لهذا النظام؟", hint: "هذا اختبار! الجواب الصحيح يحتاج تركيز.", success: "إجابة مثالية! أنت عبقري في الرياضيات وأنهيت التحدي بالكامل." }
                ]
            }
        ]
    }
...
function updateLiveLeaderboard() {
    ...
    // جلب الطلاب الحقيقيين من النظام (الذين دخلوا مسبقاً في نفس الشعبة)
    for (const [name, data] of Object.entries(studentsData)) {
        if (name !== appState.studentName && data.class === appState.studentClass) {
...
function endGame() {
    ...
    appState.currentLevelIndex = levelsData.length;
    updateTeacherDashboard();
}
