        ...
        questions: [
            {
                ...
                tutorial: {
                    title: "شرح قبل البدء: تمثيل أنظمة المعادلات بيانياً",
                    equation: "\\begin{cases} y = \\frac{1}{2}x + 1 \\\\ -2x + 4y = 4 \\end{cases}",
                    steps: [
                        { text: "أولاً: النظام الذي له حل واحد يكون له نقطة تقاطع واحدة.", math: "حل واحد" },
                        { text: "ثانياً: النظام الذي ليس له حل لا تكون له أي نقطة تقاطع (مستقيمان متوازيان).", math: "ليس للنظام حل" },
                        { text: "ثالثاً: النظام الذي له عدد لا نهائي من الحلول ينطبق مستقيماه فوق بعضهما تماماً.", math: "عدد لانهائي من الحلول" }
                    ]
                },
                equation: "\\begin{cases} y = \\frac{1}{2}x + 1 \\\\ -2x + 4y = 4 \\end{cases}",
                steps: [
